<div class="min-w-fit">
    ...
    <div id="sidebar"
        ...
        <div class="flex flex-col items-center mb-8 px-3">
            ...
            <!-- Logo -->
            <a class="block flex items-center justify-center w-16 h-16 bg-gradient-to-br from-violet-500 to-violet-600 rounded-xl shadow-lg hover:shadow-violet-500/25 transition-all duration-200 hover:scale-105 p-2"
        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <!-- Grupos de Usuarios -->
                    <li
                        class="pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-linear-to-r @if (Route::is('user-groups*')) {{ 'from-violet-500/[0.12] dark:from-violet-500/[0.24] to-violet-500/[0.04]' }} @endif">
                        <a class="block text-gray-800 dark:text-gray-100 truncate transition @if (!Route::is('user-groups*')) {{ 'hover:text-gray-900 dark:hover:text-white' }} @endif"
                            href="{{ route('user-groups.index') }}">
                            <div class="flex items-center">
                                <svg class="shrink-0 fill-current @if (Route::is('user-groups*')) {{ 'text-violet-500' }}@else{{ 'text-gray-400 dark:text-gray-500' }} @endif"
                                    xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                    viewBox="0 0 16 16">
                                    <path
                                ...
                                <span
                                    class="text-sm font-medium ml-4 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">{{ __('Grupos') }}</span>
                            </div>
                        </a>
                    </li>
                    <!-- QR -->
